...
class UserRedux extends Component {
    ...
    render() {
        ...
        let {email, password, firstName, lastName, address, phonenumber, gender, position, roleId, avatar} = this.state;
        ...
        return (
            <div className='user-redux-container'>
                ...
                <div className="container">
                        {/* <div className="row"> */}
                            <div className='row col-12'><FormattedMessage id="manage-user.add"/></div>
