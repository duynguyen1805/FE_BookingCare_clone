        ...
        return (
            <div className='doctor-more-infor-container'>
                <div className='content-up'>
                    <div className='text-address'><FormattedMessage id='patient.more-infor.text-address'/></div>
                    <div className='name-clinic'>{moreInfor && moreInfor.nameClinic ? moreInfor.nameClinic : ""}</div>
                    <div className='detail-address'>{moreInfor && moreInfor.addressClinic ? moreInfor.addressClinic : ""}</div>
                </div>
                    ...
                    {isShowDetailInforPrice === false && 
                        <div className='short-info'>
                            ...
                            <span className='detail' onClick={() => {
                                this.showHide(true)
                            }}><FormattedMessage id='patient.more-infor.detail'/></span>
                        </div>
                    }
                    {isShowDetailInforPrice === true &&
                        <>
                            <div className='title-price'><FormattedMessage id='patient.more-infor.price'/></div>
                            <div className='detail-price'>
                                <div className='price'>
                                    <span className='left'><FormattedMessage id='patient.more-infor.price'/></span>
                            ...
                            <div className='hide-price'>
                                <span onClick={() => {
                                    this.showHide(false)
                                }}><FormattedMessage id='patient.more-infor.hide-price'/></span>
                            </div>
                        </>
                    }
                </div>
